        ...
        <div class="row">
          ...
          <div class="col-md-6 offset-md-3">
            <div class="faq" id="accordion">
              <div
                class="card"
                v-for="(faq, index) in allImprovedFaqAnswers"
                :key="index"
              >
...
export default {
  ...
  data() {
    return {
      allImprovedFaqAnswers: []
    };
  },

  mounted() {
    this.fetchAllImprovedFaqAnswers();
  },

  methods: {
    fetchAllImprovedFaqAnswers() {
      axios
        .get("http://localhost:8383/api/v1/all-answered-faq")
        .then(response => {
